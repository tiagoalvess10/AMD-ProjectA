...
"""
Este codigo realiza o algoritmo de classificação Naive-Bayes presente no orange framework. Podia ser utilizado o do scikit-learn, mas deu-se preferência a esta biblioteca
