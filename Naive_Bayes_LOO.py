...
"""
Este codigo realiza o algoritmo de classificação Naive-Bayes, utilizando a biblioteca sklearn, em vez do orange framework uma vez que achou-se que neste caso 
...
uma melhor abordagem do que repartir o dataset em treino e teste apenas uma vez, como no código Naive_Bayes.py 
...
Por fim, treina com o dataset completo e guarda o modelo num ficheiro rules_NB.pkl, que é um tipo de ficheiro binários utilizado em Python para guardar objetos,
